...
public class LoginPanel extends javax.swing.JPanel {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnLoginActionPerformed
        ...
        String password = new String(txtPassword.getPassword());
        int result = userBUS.login(txtUser.getText(), password);
        if (result == UserBUS.LOGIN_WRONG_USERNAME) {
            JOptionPane.showMessageDialog(this, "Tên đăng nhập không tồn tại");
        } else if (result == UserBUS.LOGIN_WRONG_PASSWORD) {
            JOptionPane.showMessageDialog(this, "Mật khẩu không đúng");
        } else if (result == UserBUS.ACTION_SUCCESS) {
            JOptionPane.showMessageDialog(this, "Đăng nhập thành công");
            authPanel.loginSuccessPerform();
        } else {
