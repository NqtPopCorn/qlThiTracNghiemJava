...
public class CreateTestDialog extends javax.swing.JDialog {
        ...
        private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {
                ...
                if (topics.isEmpty()) {
                        JOptionPane.showMessageDialog(this, "Vui lòng chọn topics", "Lỗi", JOptionPane.ERROR_MESSAGE);
                        return;
                }
                if (timeLimit <= 0) {
                ...
                if (easyQuestions < 0 || mediumQuestions < 0 || hardQuestions < 0) {
                        JOptionPane.showMessageDialog(this, "Số câu hỏi dễ, trung bình và khó không được âm!", "Lỗi",
                                        JOptionPane.ERROR_MESSAGE);
                        return;
                }
                ...
                if (attemptLimit == null || attemptLimit.isEmpty()) {
                        JOptionPane.showMessageDialog(this, "Vui lòng chọn giới hạn số lần làm bài!", "Lỗi",
                                        JOptionPane.ERROR_MESSAGE);
                        return;
                }
                ...
                if (localDateTime.isBefore(LocalDateTime.now())) {
                        JOptionPane.showMessageDialog(this, "Ngày thi không được nhỏ hơn ngày hiện tại!", "Lỗi",
                                        JOptionPane.ERROR_MESSAGE);
                        return;
                }
                ...
                try {
                        ...
                        JOptionPane.showMessageDialog(this, "Thêm cấu trúc thành công!", "Thành công",
        ...
        private void jTextField22ActionPerformed() {// GEN-FIRST:event_jTextField22ActionPerformed
                // TODO add your handling code here:
